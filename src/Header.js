							 ...
							 <HeaderExpand>
										<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1">
											...
											<NavLink to="/"><Logo /></NavLink>
												...
												<div>
													<div className="text-4xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 inline-block">LumicAI<span className="font-normal "> Assistant</span> 
													...
													<div className="hidden md:block text-xl text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-500 inline-block">Prepare and create your own Prompts and Outputs</div>
													<div className="flex">
