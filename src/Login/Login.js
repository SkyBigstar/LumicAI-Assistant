...
class Login extends Component {
	...
	return (
		<>
			<Helmet>
				<title>{`Login - LumicAI`}</title>
			</Helmet>
			<div className="container mx-auto lg:px-4 py-4 min-h-screen flex flex-col md:items-center md:justify-center">

				<div className="text-center mb-6">
					<Logo />
					<div className="text-3xl md:text-5xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 mb-4">LumicAI<span className="font-normal "> Assistant</span>
