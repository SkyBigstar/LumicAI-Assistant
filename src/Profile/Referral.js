              ...
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="flex items-center">
				 ...
				 <div className="grid grid-cols-12">
					...
					<a rel="noopener noreferrer" href={`https://twitter.com/intent/tweet?text=Check out LumicAI and give it a try with the following link: ${window.store.landingPageUrl}/signup?referral=${this.props.store.profile.referralId}`} className="flex items-center" target="_blank">
							<div className={`cursor-pointer bg-gray-200 text-gray-700 hover:bg-gray-300 hover:text-gray-800 flex-shrink-0 inline-flex items-center justify-center md:h-16 md:w-16 h-6 w-6 rounded-full  sm:mx-0 sm:h-12 sm:w-12`}>
